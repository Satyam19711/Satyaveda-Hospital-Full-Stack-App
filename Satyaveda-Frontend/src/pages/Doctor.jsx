      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button
          ...
          className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${
            showFilter ? "bg-[#FF9933] text-white" : ""
          }`}
        >
          Filters
        </button>
        ...
        >
          ...
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "Gynecologist" ? "bg-[#FF9933] text-black" : ""
            }`}
          >
            Gynecologist
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "Dermatologist" ? "bg-[#FF9933] text-black" : ""
            }`}
          >
            Dermatologist
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "Pediatricians" ? "bg-[#FF9933] text-black" : ""
            }`}
          >
            Pediatricians
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "Neurologist" ? "bg-[#FF9933] text-black" : ""
            }`}
          >
            Neurologist
          </p>
