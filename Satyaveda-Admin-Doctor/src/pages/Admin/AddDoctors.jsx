...
const AddDoctors = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      <p className="mb-3 text-lg text-[#ff9933] font-medium">Add Doctor</p>
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-1">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input
                ...
                value={name}
                className="border bg-orange-100 rounded px-3 py-2"
                type="text"
                placeholder="Name"
                required
              />
      ...
      <div>
        ...
        <textarea
          ...
          value={about}
          className="bg-orange-100 text-gray-600 w-full px-4 pt-2 border rounded"
          rows={5}
      ...
      <button
        type="submit"
        className="bg-[#ff9933] px-10 py-3 mt-4 text-white rounded-full cursor-pointer hover:scale-105 hover:shadow-[0_0_15px_3px_rgba(255,153,51,0.7)] transition-all duration-300"
      >
        Add doctor
      </button>
    </form>
